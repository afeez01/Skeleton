...
&nbsp;<asp:TextBox ID="txtOrderLineID" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
...
&nbsp;<asp:TextBox ID="txtOrderLineDate" runat="server"></asp:TextBox>
        ...
        <br />
        <br />
        <asp:CheckBox ID="chkOrderLineConfirmed" runat="server" Text="OrderLineConfirmed" />
        <br />
        <br />
